...
[sample usage]
Standard connect scan: ./mook -p 1-1024 -t 150 192.168.1.1
MSS Option Scan: ./mook -m 1460 -n -p 1-1024 -t 150 192.168.1.1
Both: ./mook -m 1460 -p 1-1024 -t 150 192.168.1.1
...
of 2 i.e.: '-c 2'
Detailed Scan: ./mook -p 1-1024 -c 2 -r -t 150 192.168.1.1
